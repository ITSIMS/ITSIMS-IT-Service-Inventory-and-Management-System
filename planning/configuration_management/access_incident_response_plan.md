...
| ---------- | ------------ | ------ | -------------------------------------------------------------------------- | ----------------------------------------------- |
| 2026-03-26 | v1.1         | Носов  | [2026-03-24_Nosov.md](../../task-tracker/3_done/2026-03-24_Nosov.md)   | Подтверждена актуальность схемы эскалации, уточнены формулировки L2 и L3 |
...
| L2 | Верификатор (Зацепилин А.В.) | Проверка корректности воспроизведения, оценка влияния на требования верификации, подтверждение приоритета совместно с L1 | Неочевидная причина / высокий риск / инцидент затрагивает требования |
| L3 | Тимлид (Баранов А.Т.) | Решение о срочных изменениях, приоритизация исправлений в спринте, финальное согласование с заказчиком, коммуникация при срыве SLA | `P1`/`P2` или срыв SLA L2 |
