...
| ---------- | ------------ | ------- | ------------------------------------------------------------------------ | ---------------------------------- |
| 2025-12-19 | v1.1         | Баранов | —                                                                        | Добавлено правило индексации веток |
...
### 4.4 Индексация при нескольких задачах

Если у одного исполнителя несколько задач с одинаковой датой создания, к имени ветки добавляется числовой индекс:

**Формат:** `task/<ГГГГ-ММ-ДД>_<фамилия>_<индекс>`

**Примеры:**
```
task/2025-12-09_koganovsky_1    # первая задача Когановского за 09.12
task/2025-12-09_koganovsky_2    # вторая задача Когановского за 09.12
...
**Соответствие файлов и веток:**

| Файл задачи                  | Ветка Git                      |
| ---------------------------- | ------------------------------ |
| `2025-12-09_Koganovsky_1.md` | `task/2025-12-09_koganovsky_1` |
| `2025-12-09_Koganovsky_2.md` | `task/2025-12-09_koganovsky_2` |
...
| `task-tracker/3_done/2025-12-09_Koganovsky_1.md` | `task/2025-12-09_koganovsky_1` |
| `task-tracker/3_done/2025-12-09_Koganovsky_2.md` | `task/2025-12-09_koganovsky_2` |

**Правило:** Дата, фамилия и индекс (при наличии) в имени ветки берутся из имени файла задачи.
...
- [Регламент Git-процесса для верификации](./verification_git_regulation.md) — ветвление, PR и приемка артефактов верификации
