...
- [План КУ, раздел 9 (входы и выходы процесса верификации, артефакты тестирования, протоколы прогонов, отчёты о дефектах)](../configuration_management/configuration_management_plan.md#9-входы-и-выходы-процесса-верификации-артефакты-тестирования-протоколы-прогонов-отчёты-о-дефектах)
